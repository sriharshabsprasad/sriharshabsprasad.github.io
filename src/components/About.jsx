...
const About = () => (
  <motion.section
    id="about"
    className="py-24 px-4 md:px-0 flex flex-col md:flex-row items-center gap-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-500 rounded-lg shadow-lg"
  ...
  >
    ...
    >
      ...
      <p className="mb-4">
        I am a passionate Data Scientist with <strong>10+ years of diverse experience</strong> in solving real-world problems and designing innovative solutions. I specialize in <strong>Data Science, AI, Big Data, and Analytics</strong>.
      </p>
